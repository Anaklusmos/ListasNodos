...
void ListaDoble::agregarNodo(NodoDoble* n, int pos)
{
    ...
    if(pos == 0)
    {
        n->sig = inicio; //Se coloca antes del inicio, con el apuntador del nodo parámetro apuntando el siguiente al inicio.
        inicio = n;
        temp->ant = inicio; // Temporal (inicio) apunta con su apuntador -anterior- al nodo parámetro para mantenerlo en lista.
        return ;
    }
